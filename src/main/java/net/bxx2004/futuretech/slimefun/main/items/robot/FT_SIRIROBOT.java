...
import net.bxx2004.pandalib.bukkit.file.PMenuBuilder;
                ...
                try {
                    ...
                    for (Entity entity : entityCollection) {
                        if (entity instanceof Player) {
                            Bukkit.getConsoleSender().sendMessage(entity.getUniqueId(), "&cSiri &f对 &c" + player.getName() + " &f说: &9" + content.toString());
                        }
                    }
                } catch (Exception e) {
                    e.printStackTrace();
